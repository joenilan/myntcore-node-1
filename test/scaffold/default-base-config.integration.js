...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    myntd.spawn.datadir.should.equal(home + '/.mynt');
    myntd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/myntd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.myntd.spawn.datadir.should.equal('./data2');
  });
});
