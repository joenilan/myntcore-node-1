...
/**
 * Will return the path and myntcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'myntcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'myntcore-node.json'))
  };
}
