...
module.exports.services.Myntcoin = require('./lib/services/myntd');
...
module.exports.cli.myntcore = require('./lib/cli/myntcore');
module.exports.cli.myntcored = require('./lib/cli/myntcored');

module.exports.lib = require('myntcore-lib');
